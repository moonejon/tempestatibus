...
$(document).ready(function() {
    var queryURL =
        ...
        x +
        ".json?api-key=LLANXrG01LGahaCmowIvO1Ves1rF2cae";
    ...
    $.ajax({
        ...
        success: function(politics) {
            ...
            for (k = 0; k <= 5; k++) {
                ...
                politicsStoryDiv.innerHTML =
                    "<a href='" +
                    politics.results[k].url +
                    "'>" +
                    politics.results[k].title +
                    "</a>";
    ...
    $.ajax({
        ...
        success: function(sports) {
            ...
            for (k = 0; k <= 5; k++) {
                ...
                sportsStoryDiv.innerHTML =
                    "<a href='" +
                    sports.results[k].url +
                    "'>" +
                    sports.results[k].title +
                    "</a>";
                var horizontalLine = document.createElement("hr");
                horizontalLine.setAttribute("class", "uk-divider-small");
